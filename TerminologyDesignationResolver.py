...
class TerminologyDesignationResolver:
    def __init__(self,server_address, session, base_translations_conf: str = None,
    ...
    def load_base_designations_for_value_set(self, value_set: dict):
        """
    ...
    def load_base_designations(self, value_set_dir: str = None):
        """
    ...
    def load_designations(self, folder_path: str = os.path.join("code_system_translations"), update_translation_supplements=False):
        """
        ...
        if update_translation_supplements:
            ...
            response_supp_registry = self.session.get(
            ...
            for code_system_concept in supplement_registry.get('concept'):
                for prop in code_system_concept.get('property'):
                    if prop.get('code') == "supplement-canonical":
                        ...
                        response_particular_cs = self.session.get(
                        ...
                        response_cs_content = self.session.get(
